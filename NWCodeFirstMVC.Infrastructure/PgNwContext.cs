...
{
    public partial class PgNwContext : DbContext
    {
        public PgNwContext()
        {
        }

        public PgNwContext(DbContextOptions<PgNwContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
                ...
                entity.HasMany(d => d.CustomerTypes)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            ...
                            j.IndexerProperty<string>("CustomerId").HasMaxLength(5).HasColumnName("customer_id");

                            j.IndexerProperty<string>("CustomerTypeId").HasMaxLength(5).HasColumnName("customer_type_id");
                        });
            });
            ...
            {
                entity.ToTable("users"); // or "User" if you used quotes
